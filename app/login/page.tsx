...
import { Box, Button, Center, FormControl, FormLabel, Heading, Input, Text, VStack } from '@chakra-ui/react';
  ...
  return (
    ...
    >
      ...
      <VStack spacing={8} zIndex="1">
        <Heading as="h1" size="2xl" color="white" fontWeight="bold" letterSpacing="widest" textShadow="0 0 10px black">
          DOSSIÊ C
        </Heading>
        <Box
